...
tracker - the advisory review's findings arrive as a comment posted by
the agent's own account, and a comment from that account is not review
input either, and none appear below.
