...
`A Seedling` is not listed here — it is reachable from `/notes/`, which is the page the marks were built for — because linking it from the landing page would give it a backlink and push it out of the seedling stage it exists to show.
