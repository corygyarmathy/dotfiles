// https://github.com/KroneCorylus/ghostty-shader-playground/blob/main/public/shaders/cursor_blaze.glsl
...
const vec4 TRAIL_COLOR = vec4(1.0, 0.620, 0.231, 1.0); // roninYellow
const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
const vec4 TRAIL_COLOR_ACCENT = vec4(1.0, 0.365, 0.384, 1.0); // peachRed
